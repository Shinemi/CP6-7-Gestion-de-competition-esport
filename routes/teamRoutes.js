...
const { createTeam, joinTeam, addMember, removeMember , deleteTeam, getTeamDetails, getMyTeamTournaments} = require('../controllers/teamController')
...
router.get('/:teamId/teamTournaments', authMiddleware, getMyTeamTournaments)  
